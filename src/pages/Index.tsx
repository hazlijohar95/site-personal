    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      <div ref={homeRef} className="min-h-screen flex flex-col items-center justify-center p-6">
        <div className="max-w-5xl w-full text-center">
          ...
          <div className="mb-8">
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 font-mono border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg inline-block">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button 
              ...
              className="glass-button bg-blue-600 text-white dark:bg-blue-700 dark:text-white"
            >
              Discover My Story
            </button>
            <button 
